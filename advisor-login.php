...
{
$ret=mysqli_query($con,"SELECT * FROM advisor WHERE fullName='".$_POST['username']."' and password='".$_POST['password']."'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="advisor-dashboard.php";//
					...
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="new-account">
								...
								<a href="advisor-registration.php">
									Create an account
								</a>
							</div>
						</fieldset>
